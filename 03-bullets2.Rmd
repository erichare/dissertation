...
## DONE put actual and predicted in the tables in ch 3
## DONE switch to scientific notation (or < .0001) for all p-values
## DONE move the KS test table to the appendix for that one paper
## DONE Switch single ks test to a parenthetical in the text
## DONE Facet by sensitivity and specificity, 3 lines for each
## DONE Start that plot at 100%, label it "% land used" - call it "left fixed", "middle fixed", "right fixed"
## DONE Move histograms to the appendix
## DONE Try without signature length?
## DONE Take plot out of first land to land idea
## DONE Feature expression as a function of degradation
## DONE Take a scratched bullet we excluded, (BR9 b24?) and try to match using degraded
...
ggplot(result, aes(x = level, y = value, colour = fixed)) +
    ...
    geom_line() +
    theme_bw() +
    scale_x_continuous(breaks = c(0, .125, .25, .375, .5), labels = c("100%", "87.5%", "75%", "62.5%", "50%")) +
