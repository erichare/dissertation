...
```{r bullets-app, echo=FALSE, fig.pos='H'}
...
- Focuses on the construction of a modular software system using **intRo** itself as a case-study.
...
```{r lineup, echo=FALSE, fig.align='center'}
...
```{r lineup-app, echo=FALSE, fig.align='center'}
...
```{r timeline, echo=FALSE, fig.align='center'}
