...
- **S** is the the sum of the average heights of matched striae.
...
<img src="images/ccfstudy-1.png" width="400">

## Ideal Cross-Section by Study

<img src="images/crosscompare-1.png" width="750">
...
Idea: Two bullets $b_1$ and $b_2$ are matches if and only if some land $l_{b1}$ from $b_1$ matches some land $l_{b2}$ from bullet 2.<br>
Corollary: Two bullets are non-matches if and only if no land from $b_1$ matches a land from $b_2$.<br>
Assumption: Each land on a bullet is independent of each other land

<img src="images/equation.png" width="750">
...
<img src="images/scores-1.png" width="750">

## Bullet Method 2

Assumption: Bullets match if and only if all lands match, and each land on a bullet is independent of each other land

<img src="images/scores1-1.png" width="500">

## Bullet Method 3: Hybrid

Average the scores along the maximal diagonal.

Assumption: Each land-to-land comparison score for a bullet is a realization of an independent, identically distributed Bernoulli random variable.

<img src="images/scores10-1.png" width="500">

# Modern Bullet Matching Application
...
<img src="images/schema.png" width="850">
...
The three papers comprising this thesis are in various states of completion:

1. Automatic Matching of Bullet Lands is submitted and under review by the Annals of Applied Statistics
2. Bullet Land Feature Analysis is nearly complete and ready to submit
3. A Modern Bullet Matching Application needs a bit more tender love and care

Automatic Matching of Bullet Lands was set back a bit by some reviewer comments on the second round of revisions...
...
As Iowa State University and NIST continue to collaborate, we will likely have several more individuals scanning and uploading surface scans of bullets, and this will need to be further investigated to ensure the algorithms withstand real-world scenarios of scan quality.
