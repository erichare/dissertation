...
```{r sigs, echo=FALSE, message=FALSE, warning=FALSE, fig.height=3, fig.width=6, fig.cap='The signature obtained by processing the profile of land id 65 at x = 100.'}
result <- dbGetQuery(con, "SELECT * FROM signatures WHERE profile_id = 32448")
